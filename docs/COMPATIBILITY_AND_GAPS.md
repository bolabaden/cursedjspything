...
**Evidence:** `test/cpython-derived/str-encode.test.ts`, `str-format.test.ts`, `str-reversed.test.ts`, `str-bool.test.ts`, `frozenset-hash.test.ts`, `frozenset-set-algebra.test.ts`, `frozenset-set-eq.test.ts`, `frozenset-iter.test.ts`, `frozenset-set-ordering.test.ts`, `set-frozenset-inplace.test.ts`, `frozenset-set-methods.test.ts`, `set-mutation.test.ts`, `frozenset-set-named-algebra.test.ts`, `bytes-iter.test.ts`, `bytes-hash.test.ts`, `bytes-bytes.test.ts`, `bytes-bool.test.ts`, `bool-bool.test.ts`, `bytes-reversed.test.ts`, `bytes-decode.test.ts`, `bytes-join.test.ts`, `bytes-split.test.ts`, `bytes-rsplit.test.ts`, `bytes-startswith-endswith.test.ts`, `bytes-removeprefix-removesuffix.test.ts`, `bytes-expandtabs.test.ts`, `bytes-hex-fromhex.test.ts`, `bytes-predicates.test.ts`, `bytes-translate.test.ts`, `bytes-isascii-contains.test.ts`, `bytes-partition.test.ts`, `bytes-splitlines.test.ts`, `bytes-strip.test.ts`, `bytes-find.test.ts`, `bytes-index.test.ts`, `bytes-count.test.ts`, `bytes-replace.test.ts`, `bytes-upper-lower.test.ts`, `bytes-capitalize.test.ts`, `bytes-swapcase.test.ts`, `bytes-center.test.ts`, `bytes-ljust-rjust.test.ts`, `bytes-zfill.test.ts`, `bytes-title.test.ts`, `bytes-getitem-compare.test.ts`, `bytes-slice-index.test.ts`, `operator-bool-float.test.ts`, `operator-bool-str-binary.test.ts`, `operator-bool-str-remaining-binary.test.ts`, `operator-bytes-conversion.test.ts`, `operator-bytes-cross-type.test.ts`, `operator-bytes-remaining-cross-type.test.ts`, `operator-str-bytes-cross-type.test.ts`, `operator-float-str-binary.test.ts`, `operator-float-str-divmod-pow.test.ts`, `operator-float-str-floordiv-mod.test.ts`, `operator-float-str-remaining-binary.test.ts`, `operator-format-evidence.test.ts`, `operator-inplace-cross-type.test.ts`, `operator-int-bool.test.ts`, `operator-int-float.test.ts`, `operator-int-str-binary.test.ts`, `operator-int-str-divmod-pow.test.ts`, `operator-int-str-remaining-binary.test.ts`, `operator-str-int-remaining-binary.test.ts`, `operator-matmul-evidence.test.ts`, `operator-numeric-conversion-evidence.test.ts`, `operator-rounding-evidence.test.ts`, `operator-container-cross-type.test.ts`, `operator-list-tuple-cross-type.test.ts`, `operator-sequence-cross-type-add.test.ts`, `operator-str-float.test.ts`, `operator-str-float-remaining-binary.test.ts`, `operator-str-scalar.test.ts`, `operator-unary-evidence.test.ts`, `sequence-cross-type.test.ts`, `sequence-repeat-bool.test.ts`, `sequence-repeat-nonint.test.ts`, `dict-bool.test.ts`, `float-bool.test.ts`, `frozenset-bool.test.ts`, `int-bool.test.ts`, `list-reversed.test.ts`, `list-bool.test.ts`, `none-bool.test.ts`, `set-bool.test.ts`, `slice-bool.test.ts`, `tuple-bool.test.ts`, and `tuple-reversed.test.ts` port thin matrices from CPython `Lib/test/test_operator.py` / rich-compare spirit. Golden keys: `int_float_*`, `bool_int_*`, `bool_float_*`. **Remaining gap:** PEP 3118 buffer protocol not implemented; niche bytes/str API edge cases may still differ from CPython; float↔str pairs are not coerced beyond the evidenced binary slots.
