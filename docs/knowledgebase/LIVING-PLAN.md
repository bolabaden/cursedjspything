...
- [REPO] Plan **918** (in progress) — complex `/` with bool subclass operands.
...
1. Complex scalar bool `/` (plan 918).
...
- [REPO] Plan **915** merged to `main` via PR [#583](https://github.com/bolabaden/cursedjspything/pull/583) @ `fb24582` — `float.as_integer_ratio()` bigint components for `0.1`-class denominators.
...
1. Complex scalar bool evidence (plan 916).
...
- [REPO] Plan 841 merged via PR #509 — plan 840 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 840 merge PR #508)

### Landed

- [REPO] Plan 840 merged via PR #508 — plan 839 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 839 merge PR #507)

### Landed

- [REPO] Plan 839 merged via PR #507 — plan 838 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 838 merge PR #506)

### Landed

- [REPO] Plan 838 merged via PR #506 — plan 837 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
- [REPO] Plan 836 merged via PR #504 — plan 835 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 835 merge PR #503)

### Landed

- [REPO] Plan 835 merged via PR #503 — plan 834 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 834 merge PR #502)

### Landed

- [REPO] Plan 834 merged via PR #502 — plan 833 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 833 merge PR #501)

### Landed

- [REPO] Plan 833 merged via PR #501 — plan 832 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 832 merge PR #500)

### Landed

- [REPO] Plan 832 merged via PR #500 — plan 831 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 831 merge PR #499)

### Landed

- [REPO] Plan 831 merged via PR #499 — plan 830 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 830 merge PR #498)

### Landed

- [REPO] Plan 830 merged via PR #498 — plan 829 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 829 merge PR #497)

### Landed

- [REPO] Plan 829 merged via PR #497 — plan 828 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 828 merge PR #496)

### Landed

- [REPO] Plan 828 merged via PR #496 — plan 827 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 827 merge PR #495)

### Landed

- [REPO] Plan 827 merged via PR #495 — plan 826 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 826 merge PR #494)

### Landed

- [REPO] Plan 826 merged via PR #494 — plan 825 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 825 merge PR #493)

### Landed

- [REPO] Plan 825 merged via PR #493 — plan 824 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 824 merge PR #492)

### Landed

- [REPO] Plan 824 merged via PR #492 — plan 823 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 823 merge PR #491)

### Landed

- [REPO] Plan 823 merged via PR #491 — plan 822 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 822 merge PR #490)

### Landed

- [REPO] Plan 822 merged via PR #490 — plan 821 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 821 merge PR #489)

### Landed

- [REPO] Plan 821 merged via PR #489 — plan 820 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 820 merge PR #488)

### Landed

- [REPO] Plan 820 merged via PR #488 — plan 819 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 819 merge PR #487)

### Landed

- [REPO] Plan 819 merged via PR #487 — plan 818 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 818 merge PR #486)

### Landed

- [REPO] Plan 818 merged via PR #486 — plan 817 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 817 merge PR #485)

### Landed

- [REPO] Plan 817 merged via PR #485 — plan 816 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 816 merge PR #484)

### Landed

- [REPO] Plan 816 merged via PR #484 — plan 815 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 815 merge PR #483)

### Landed

- [REPO] Plan 815 merged via PR #483 — plan 814 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 814 merge PR #482)

### Landed

- [REPO] Plan 814 merged via PR #482 — plan 813 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 813 merge PR #481)

### Landed

- [REPO] Plan 813 merged via PR #481 — plan 812 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 812 merge PR #480)

### Landed

- [REPO] Plan 812 merged via PR #480 — plan 811 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 811 merge PR #479)

### Landed

- [REPO] Plan 811 merged via PR #479 — plan 810 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 810 merge PR #478)

### Landed

- [REPO] Plan 810 merged via PR #478 — plan 809 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 809 merge PR #477)

### Landed

- [REPO] Plan 809 merged via PR #477 — plan 808 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 808 merge PR #476)

### Landed

- [REPO] Plan 808 merged via PR #476 — plan 807 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 807 merge PR #475)

### Landed

- [REPO] Plan 807 merged via PR #475 — plan 806 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 806 merge PR #474)

### Landed

- [REPO] Plan 806 merged via PR #474 — plan 805 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 805 merge PR #473)

### Landed

- [REPO] Plan 805 merged via PR #473 — plan 804 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 804 merge PR #472)

### Landed

- [REPO] Plan 804 merged via PR #472 — plan 803 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 803 merge PR #471)

### Landed

- [REPO] Plan 803 merged via PR #471 — plan 802 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 802 merge PR #470)

### Landed

- [REPO] Plan 802 merged via PR #470 — plan 801 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 801 merge PR #469)

### Landed

- [REPO] Plan 801 merged via PR #469 — plan 800 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 800 merge PR #468)

### Landed

- [REPO] Plan 800 merged via PR #468 — plan 799 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 799 merge PR #467)

### Landed

- [REPO] Plan 799 merged via PR #467 — plan 798 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 798 merge PR #466)

### Landed

- [REPO] Plan 798 merged via PR #466 — plan 797 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 797 merge PR #465)

### Landed

- [REPO] Plan 797 merged via PR #465 — plan 796 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 796 merge PR #464)

### Landed

- [REPO] Plan 796 merged via PR #464 — plan 795 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
- [REPO] Plan 794 merged via PR #462 — plan 793 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 793 merge PR #461)

### Landed

- [REPO] Plan 793 merged via PR #461 — plan 792 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 792 merge PR #460)

### Landed

- [REPO] Plan 792 merged via PR #460 — plan 791 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 791 merge PR #459)

### Landed

- [REPO] Plan 791 merged via PR #459 — plan 790 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 790 merge PR #458)

### Landed

- [REPO] Plan 790 merged via PR #458 — plan 789 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 789 merge PR #457)

### Landed

- [REPO] Plan 789 merged via PR #457 — plan 788 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 788 merge PR #456)

### Landed

- [REPO] Plan 788 merged via PR #456 — plan 787 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 787 merge PR #455)

### Landed

- [REPO] Plan 787 merged via PR #455 — plan 786 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 786 merge PR #454)

### Landed

- [REPO] Plan 786 merged via PR #454 — plan 785 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 785 merge PR #453)

### Landed

- [REPO] Plan 785 merged via PR #453 — plan 784 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 784 merge PR #452)

### Landed

- [REPO] Plan 784 merged via PR #452 — plan 783 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 783 merge PR #451)

### Landed

- [REPO] Plan 783 merged via PR #451 — plan 782 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 782 merge PR #450)

### Landed

- [REPO] Plan 782 merged via PR #450 — plan 781 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 781 merge PR #449)

### Landed

- [REPO] Plan 781 merged via PR #449 — plan 780 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 780 merge PR #448)

### Landed

- [REPO] Plan 780 merged via PR #448 — plan 779 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 779 merge PR #447)

### Landed

- [REPO] Plan 779 merged via PR #447 — plan 778 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 778 merge PR #446)

### Landed

- [REPO] Plan 778 merged via PR #446 — plan 777 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 777 merge PR #445)

### Landed

- [REPO] Plan 777 merged via PR #445 — plan 776 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
- [REPO] Plan 775 merged via PR #443 — plan 774 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 774 merge PR #442)

### Landed

- [REPO] Plan 774 merged via PR #442 — plan 773 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 773 merge PR #441)

### Landed

- [REPO] Plan 773 merged via PR #441 — plan 772 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 772 merge PR #440)

### Landed

- [REPO] Plan 772 merged via PR #440 — plan 771 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 771 merge PR #439)

### Landed

- [REPO] Plan 771 merged via PR #439 — plan 770 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 770 merge PR #438)

### Landed

- [REPO] Plan 770 merged via PR #438 — plan 769 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 769 merge PR #437)

### Landed

- [REPO] Plan 769 merged via PR #437 — plan 768 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 768 merge PR #436)

### Landed

- [REPO] Plan 768 merged via PR #436 — plan 767 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 767 merge PR #435)

### Landed

- [REPO] Plan 767 merged via PR #435 — plan 766 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 766 merge PR #434)

### Landed

- [REPO] Plan 766 merged via PR #434 — plan 765 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 765 merge PR #433)

### Landed

- [REPO] Plan 765 merged via PR #433 — plan 764 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 764 merge PR #432)

### Landed

- [REPO] Plan 764 merged via PR #432 — plan 763 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 763 merge PR #431)

### Landed

- [REPO] Plan 763 merged via PR #431 — plan 762 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 762 merge PR #430)

### Landed

- [REPO] Plan 762 merged via PR #430 — plan 761 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 761 merge PR #429)

### Landed

- [REPO] Plan 761 merged via PR #429 — plan 760 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 760 merge PR #428)

### Landed

- [REPO] Plan 760 merged via PR #428 — plan 759 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 759 merge PR #427)

### Landed

- [REPO] Plan 759 merged via PR #427 — plan 758 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 758 merge PR #426)

### Landed

- [REPO] Plan 758 merged via PR #426 — plan 757 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 757 merge PR #425)

### Landed

- [REPO] Plan 757 merged via PR #425 — plan 756 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 756 merge PR #424)

### Landed

- [REPO] Plan 756 merged via PR #424 — plan 755 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 755 merge PR #423)

### Landed

- [REPO] Plan 755 merged via PR #423 — plan 754 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 754 merge PR #422)

### Landed

- [REPO] Plan 754 merged via PR #422 — plan 753 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 753 merge PR #421)

### Landed

- [REPO] Plan 753 merged via PR #421 — plan 752 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 752 merge PR #420)

### Landed

- [REPO] Plan 752 merged via PR #420 — plan 751 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 751 merge PR #419)

### Landed

- [REPO] Plan 751 merged via PR #419 — plan 750 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 750 merge PR #418)

### Landed

- [REPO] Plan 750 merged via PR #418 — plan 749 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 749 merge PR #417)

### Landed

- [REPO] Plan 749 merged via PR #417 — plan 748 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 748 merge PR #416)

### Landed

- [REPO] Plan 748 merged via PR #416 — plan 747 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 747 merge PR #415)

### Landed

- [REPO] Plan 747 merged via PR #415 — plan 746 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 746 merge PR #414)

### Landed

- [REPO] Plan 746 merged via PR #414 — plan 745 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 745 merge PR #413)

### Landed

- [REPO] Plan 745 merged via PR #413 — plan 744 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 744 merge PR #412)

### Landed

- [REPO] Plan 744 merged via PR #412 — plan 743 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 743 merge PR #411)

### Landed

- [REPO] Plan 743 merged via PR #411 — plan 742 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 742 merge PR #410)

### Landed

- [REPO] Plan 742 merged via PR #410 — plan 741 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 741 merge PR #409)

### Landed

- [REPO] Plan 741 merged via PR #409 — plan 740 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 740 merge PR #408)

### Landed

- [REPO] Plan 740 merged via PR #408 — plan 739 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 739 merge PR #407)

### Landed

- [REPO] Plan 739 merged via PR #407 — plan 738 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 738 merge PR #406)

### Landed

- [REPO] Plan 738 merged via PR #406 — plan 737 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 737 merge PR #405)

### Landed

- [REPO] Plan 737 merged via PR #405 — plan 736 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 736 merge PR #404)

### Landed

- [REPO] Plan 736 merged via PR #404 — plan 735 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 735 merge PR #403)

### Landed

- [REPO] Plan 735 merged via PR #403 — plan 734 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 734 merge PR #402)

### Landed

- [REPO] Plan 734 merged via PR #402 — plan 733 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 733 merge PR #401)

### Landed

- [REPO] Plan 733 merged via PR #401 — plan 732 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 732 merge PR #400)

### Landed

- [REPO] Plan 732 merged via PR #400 — plan 731 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 731 merge PR #399)

### Landed

- [REPO] Plan 731 merged via PR #399 — plan 730 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 730 merge PR #398)

### Landed

- [REPO] Plan 730 merged via PR #398 — plan 729 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 729 merge PR #397)

### Landed

- [REPO] Plan 729 merged via PR #397 — plan 728 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 728 merge PR #396)

### Landed

- [REPO] Plan 728 merged via PR #396 — plan 727 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 727 merge PR #395)

### Landed

- [REPO] Plan 727 merged via PR #395 — plan 726 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 726 merge PR #394)

### Landed

- [REPO] Plan 726 merged via PR #394 — plan 725 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 725 merge PR #393)

### Landed

- [REPO] Plan 725 merged via PR #393 — plan 724 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 724 merge PR #392)

### Landed

- [REPO] Plan 724 merged via PR #392 — plan 723 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 723 merge PR #391)

### Landed

- [REPO] Plan 723 merged via PR #391 — plan 722 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
- [REPO] Plan 721 merged via PR #389 — plan 720 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 720 merge PR #388)

### Landed

- [REPO] Plan 720 merged via PR #388 — plan 719 merge record in LIVING-PLAN (1202 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 719 merge PR #387)

### Landed

- [REPO] Plan 719 merged via PR #387 — `list.__imul__` bool repeat Vitest; §8.6 evidence (1202 Vitest / 163 files).
...
- [REPO] Plan 715 merged via PR #383 — §8.15 __mul__/__rmul__ int clarify (1200 Vitest / 163 files).
...
- [REPO] Plan 713 merged via PR #381 — §8.15 int*list/tuple mul evidence (1200 Vitest / 163 files).
...
- [REPO] Plan 711 merged via PR #379 — plan 710 merge record in LIVING-PLAN (1200 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 710 merge PR #378)

### Landed

- [REPO] Plan 710 merged via PR #378 — plan 709 merge record in LIVING-PLAN (1200 Vitest / 163 files).
...
- [REPO] Plan 707 merged via PR #375 — `int * bytes` mul reject; §8.15 evidence (1196 Vitest / 163 files).
...
- [REPO] Plan 705 merged via PR #373 — `int * str` mul reject; §8.15 evidence (1194 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 705)

### Landed

- [REPO] Plan 705 — `int * str` mul reject via `str.__rmul__` guard; Vitest + §8.15 (1194 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 704 merge PR #372)

### Landed

- [REPO] Plan 704 merged via PR #372 — plan 703 merge record in LIVING-PLAN (1192 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 703 merge PR #371)

### Landed

- [REPO] Plan 703 merged via PR #371 — plan 702 merge record in LIVING-PLAN (1192 Vitest / 163 files).
...
- [REPO] Plan 701 merged via PR #369 — `isub(list, list)` reject; list `-=` matrix complete (1192 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 701)

### Landed

- [REPO] Plan 701 — `isub(list, list)` reject in `sequence-sub.test.ts`; §8.6 docs (1192 Vitest / 163 files).
...
## Delta update (2026-05-24, plan 700 merge PR #368)

### Landed

- [REPO] Plan 700 merged via PR #368 — list/tuple `-` dict rejects (1191 Vitest / 163 files).
...
- [REPO] Plan 684 merged via PR #356 — list↔tuple cross-type ordering in `sequence-ordering-cross-type.test.ts`; §8.6 docs; validation-ladder sync (1191 Vitest / 164 files).
...
- [REPO] Plan 672 merged via PR #350 — `list += tuple` in-place extend evidence in `sequence-iadd.test.ts`; §8.6 docs; validation-ladder sync (1172 Vitest / 160 files).
...
## Delta update (2026-06-04, plan 670 merge PR #349)

### Landed

- [REPO] Plan 670 merged via PR #349 — list↔tuple heterogeneous `*` `__mul__` evidence in `sequence-mul-cross-type.test.ts`; §8.6 docs; validation-ladder sync (1170 Vitest / 160 files).
...
- [REPO] Plan 666 merged via PR #347 — `list * str` cross-type `__mul__` evidence in `sequence-mul-cross-type.test.ts`; §8.6 docs; validation-ladder sync (1167 Vitest / 160 files).
...
## Delta update (2026-06-04, plan 664 merge PR #346)

### Landed

- [REPO] Plan 664 merged via PR #346 — `tuple * str` cross-type `__mul__` evidence in `sequence-mul-cross-type.test.ts`; §8.6 docs; validation-ladder sync (1166 Vitest / 160 files).
...
- [REPO] Plan 660 merged via PR #344 — `tuple.__add__` cross-type `+` rejects for str/bytes in `sequence-add.test.ts`; §8.6 docs; validation-ladder sync (1163 Vitest / 159 files).
...
## Delta update (2026-06-04, plan 658 merge PR #343)

### Landed

- [REPO] Plan 658 merged via PR #343 — `list.__iadd__` cross-type `+=` rejects for float/bool in `sequence-iadd.test.ts`; §8.6 docs; validation-ladder sync (1161 Vitest / 159 files).
...
- [REPO] Plan 638 merged via PR #333 — `str.__add__` same-type concatenation evidence (`str-add.test.ts`); §8.15 docs; validation-ladder sync (1140 Vitest / 158 files).
...
## Delta update (2026-06-04, plan 636 merge PR #332)

### Landed

- [REPO] Plan 636 merged via PR #332 — `list.__iadd__` in-place extend with list evidence (`sequence-iadd.test.ts`); §8.6 docs; validation-ladder sync (1138 Vitest / 157 files).
...
- [REPO] Plan 630 merged via PR #329 — tuple/frozenset `__hash__` equal-but-distinct element evidence; §8.5 docs; validation-ladder sync (1129 Vitest / 154 files).
...
- [REPO] Plan 626 merged via PR #327 — `dict_values` view contains + `ne()` hash+eq dict evidence; §8.5 docs; validation-ladder sync (1124 Vitest / 153 files).
...
- [REPO] Plan 618 merged via PR #323 — frozenset/set `|&-^` hash+eq cross-type evidence in `frozenset-set-algebra.test.ts`; §8.5 / §8.15 docs; validation-ladder sync (1108 Vitest / 151 files). Set/frozenset hash+eq evidence stack (592, 610–618) complete for documented surfaces.
...
- [REPO] Plan 610 merged via PR #319 — `issubset`/`issuperset`/`isdisjoint` hash+eq evidence in `frozenset-set-methods.test.ts`; §8.5 / §8.15 docs; validation-ladder sync (1104 Vitest / 151 files).
...
- [REPO] Plan 606 merged via PR #317 — `dict.keys` / `values` / `items` live views; `dict-keys-values-items-views.test.ts`; §8.5 / §10.6 docs; validation-ladder sync (1098 Vitest / 150 files).
...
- [REPO] Plan 598 merged via PR #313 — `dict.get(key[, default])` via `dictGet`; `dict-get.test.ts`; §8.5 docs; validation-ladder sync (1077 Vitest / 146 files).
...
- [REPO] Plan 594 merged via PR #311 — `intersection_update`, `difference_update`, `symmetric_difference_update` on `set` with hash+eq; `set-named-update-methods.test.ts`; §8.15 docs; validation-ladder sync (1068 Vitest / 144 files).
...
## Delta update (2026-06-04, plan 592 merge PR #310)

### Landed

- [REPO] Plan 592 merged via PR #310 — `unionItems` uses `setAddMember`; `set-algebra-membership.test.ts` for `|&-^` and named algebra with equal keys; §8.5 docs; validation-ladder sync (1062 Vitest / 143 files).
...
- [REPO] Plan 586 merged via PR #307 — `tuple.__hash__` uses per-element `hash()` (no silent `0` for missing `__hash__`); `tuple-hash.test.ts`; validation-ladder sync (1028 Vitest / 140 files).
...
- [REPO] Plan 578 merged via PR #303 — `hash(frozenset)` rejects unhashable and invalid-`__hash__` elements in `frozenset-hash.test.ts`; validation-ladder sync (1022 Vitest / 140 files).
...
## Delta update (2026-06-04, plan 576 merge PR #302)

### Landed

- [REPO] Plan 576 merged via PR #302 — dict key hash strictness on `delItem`/`contains` and unhashable list keys in `dict-keys.test.ts`; validation-ladder sync (1020 Vitest / 140 files).
...
- [REPO] Plan 550 merged via PR #289 — `str.encode` / `bytes.decode` on empty input; validation-ladder sync (977 Vitest / 132 files).
...
## Delta update (2026-06-04, plan 548 merge PR #288)

### Landed

- [REPO] Plan 548 merged via PR #288 — `str`/`bytes.removeprefix` and `removesuffix` on empty input with non-empty missing affix; validation-ladder sync (977 Vitest / 132 files).
...
## Delta update (2026-06-04, plan 546 merge PR #287)

### Landed

- [REPO] Plan 546 merged via PR #287 — `str`/`bytes.replace` on empty input with non-empty missing `old` → empty; validation-ladder sync (977 Vitest / 132 files).
...
## Delta update (2026-06-04, plan 544 merge PR #286)

### Landed

- [REPO] Plan 544 merged via PR #286 — `str`/`bytes.count` on empty input with missing sub → `0`; validation-ladder sync (977 Vitest / 132 files).
...
## Delta update (2026-06-04, plan 542 merge PR #285)

### Landed

- [REPO] Plan 542 merged via PR #285 — `str`/`bytes.startswith` and `endswith` on empty haystack (non-empty affix → false, empty affix → true); validation-ladder sync (977 Vitest / 132 files).
...
- [REPO] Plan 538 merged via PR #283 — `str`/`bytes.find` and `rfind` on empty input with missing sub → `-1`; validation-ladder sync (977 Vitest / 132 files).
...
- [REPO] Plan 530 merged via PR #279 — `str`/`bytes.expandtabs` on empty input with optional tabsize; validation-ladder sync (977 Vitest / 132 files).
...
- [REPO] Plan 524 merged via PR #276 — `str`/`bytes` `partition`/`rpartition` multi-byte exact-match triples; validation-ladder sync (977 Vitest / 132 files).
...
## Delta update (2026-06-04, plan 522 merge PR #275)

### Landed

- [REPO] Plan 522 merged via PR #275 — `str`/`bytes.ljust(0)` no-op parity; validation-ladder sync (977 Vitest / 132 files).
...
- [REPO] Plan 518 merged via PR #273 — `str`/`bytes.join` empty separator + empty iterable; validation-ladder sync (977 Vitest / 132 files).
...
## Delta update (2026-06-04, plan 516 merge PR #272)

### Landed

- [REPO] Plan 516 merged via PR #272 — `str`/`bytes` `split`/`rsplit` whitespace-only `maxsplit=0` returns `[]`; validation-ladder sync (977 Vitest / 132 files).
...
- [REPO] Plan 512 merged via PR #270 — `str`/`bytes.replace` on empty input with empty `old` + `count=0` no-op; validation-ladder sync (973 Vitest / 132 files).
...
## Delta update (2026-06-04, plan 510 merge PR #269)

### Landed

- [REPO] Plan 510 merged via PR #269 — `str.join` / `bytes.join` empty-separator concatenation; validation-ladder sync (971 Vitest / 132 files).
...
- [REPO] Plan 504 merged via PR #266 — `bytes.rpartition` exact-match triple parity with `bytes.partition` / `str.rpartition`; validation-ladder sync (966 Vitest / 132 files).
...
## Delta update (2026-06-04, plan 502 merge PR #265)

### Landed

- [REPO] Plan 502 merged via PR #265 — `str.lstrip` / `str.rstrip` empty `chars` parity with `str.strip` and `bytes.strip`; validation-ladder sync (965 Vitest / 132 files).
...
## Delta update (2026-06-04, plan 500 merge PR #264)

### Landed

- [REPO] Plan 500 merged via PR #264 — `str.splitlines` / `bytes.splitlines` lone carriage return + `keepends`; validation-ladder sync (965 Vitest / 132 files).
...
- [REPO] Plan 496 merged via PR #262 — `str.rpartition` empty-string triple parity with `str.partition`; validation-ladder sync (962 Vitest / 132 files).
...
- [REPO] Plan 486 merged via PR #257 — `bytes.split` / `bytes.rsplit` `maxsplit=0` with explicit comma separator (parity with plan 484 `str.split`); validation-ladder sync (958 Vitest / 132 files).
