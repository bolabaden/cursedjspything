...
| `test/cpython-derived/sequence-repeat-bool.test.ts` | list/tuple/bytes bool and negative repeat; multi-element and spread-safe large repeat (plans 640/644 bytes) |
