...
| `test/cpython-derived/sequence-repeat-bool.test.ts` | list/tuple/bytes bool repeat; negative repeat; multi-element and spread-safe large repeat (plan 640 bytes) |
