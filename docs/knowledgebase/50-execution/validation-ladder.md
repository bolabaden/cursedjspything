...
| `test/cpython-derived/sequence-repeat-bool.test.ts` | list/tuple/bytes bool, negative, multi-element repeat; spread-safe large repeat (plans 640/644/646 bytes) |
